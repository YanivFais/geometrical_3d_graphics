function [Nv,Nt] = compute_normals (surface_x)
...
idx1 = sub2ind(size(TNEIGH), surface_x.TRIV(:,1), [1:size(surface_x.TRIV,1)]');
idx2 = sub2ind(size(TNEIGH), surface_x.TRIV(:,2), [1:size(surface_x.TRIV,1)]');
idx3 = sub2ind(size(TNEIGH), surface_x.TRIV(:,3), [1:size(surface_x.TRIV,1)]');
TNEIGH(idx1) = 1;
TNEIGH(idx2) = 1;
TNEIGH(idx3) = 1;
